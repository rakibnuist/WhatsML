...
class ModuleDeveloperSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($moduleLists as $key => $value) {
            ...
            $moduleLists[$key]['id'] = strtolower($module->get('alias', $module->get('name')));


            $settingsRoute = "admin.{$moduleLists[$key]['id']}.settings.index";

            if (Route::has($settingsRoute)) {
                $moduleLists[$key]['settings_url'] = route($settingsRoute);
            }
    ...
    public function store(Request $request)
    {
        ...
        // for build folder
        $buildFolder = 'build-modules/' . str($firstFolder)->studly()->toString();
    ...
    public function changeStatus(Request $request)
    {
        ...
        foreach ($moduleMenuType as $key) {
            ...
            $menuPath = database_path("/json/{$key}_menu.json");
