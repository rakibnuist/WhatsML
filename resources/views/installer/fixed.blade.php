        ...
        <div class="installer-container" style="max-width: 600px; width: 100%;">
            ...
            <div class="installer-body">
                ...
                <div class="step active" id="step1">
                    ...
                    <div class="waiting-bar" id="waitingBar1">
                ...
                <div class="step" id="step4">
                    <h3><i class="fas fa-check-circle"></i> Ready for Launch</h3>
    ...
    <script>
        ...
        async function checkRequirements() {
            ...
            try {
                ...
                if (data.all_met) {
                    enableNextButton(1);
                    console.log('All requirements met, next button enabled');
                } else {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('DOM loaded, starting requirements check...');
            setTimeout(() => {
                checkRequirements();
